  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <fieldset className="space-y-4">
        <legend className="t-label">Información básica</legend>
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            className="block w-full rounded-md border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-sm focus:border-accent-500 focus:outline-none focus:ring-2 focus:ring-accent-500"
          >
      ...
      {/* --- Compra --- */}
      <fieldset className="space-y-4">
        <legend className="t-label">Compra</legend>
      ...
      {/* --- Garantía --- */}
      <fieldset className="space-y-4">
        <legend className="t-label">Garantía</legend>
        <div className="grid gap-4 sm:grid-cols-2 rounded-md border border-[var(--border)] p-4">
          <div className="space-y-1">
      ...
      <fieldset className="space-y-4">
        <legend className="t-label">Estado y seguimiento</legend>
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-1">
